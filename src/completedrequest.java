 ...
 * @author Asus
 */
public class completedrequest extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("All Completed Requests");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 11, 440, -1));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
         ...
         try
         {
             ...
             ResultSet rs=st.executeQuery("select *from bloodreq where status='completed' order by RequestId");
             //jTable1.setAutoResizeMode(jTable1.AUTO_RESIZE_OFF);
             jTable1.setModel(net.proteanit.sql.DbUtils.resultSetToTableModel(rs));
             Statement req=con.createStatement();
             ResultSet rst=req.executeQuery("select min(RequestId) from bloodreq where status='completed'");
            if(rst.next())
            {
                int id=rst.getInt(1);
